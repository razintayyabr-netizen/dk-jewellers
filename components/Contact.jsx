    ...
    <section id="contact" className="section">
      <div className="section-inner">
        ...
        <div className="contact-grid">
          <a href="tel:+91875038065" className="contact-card">
            <div className="contact-icon">📞</div>
            <h3>Call Us</h3>
            <p className="value">875038065</p>
            <p className="sub">Tap to call</p>
          </a>
          <a href="https://wa.me/91875038065?text=Hi! I'd like to enquire about jewellery" target="_blank" className="contact-card">
            <div className="contact-icon" style={{ background: 'rgba(16,185,129,0.06)', borderColor: 'rgba(16,185,129,0.08)' }}>💬</div>
            <h3>WhatsApp</h3>
            <p className="value" style={{ color: '#34D399' }}>875038065</p>
        ...
        <p className="contact-address">📍 Hastal, Uttam Nagar, Delhi · <a href="https://maps.google.com/?q=Hastal+Uttam+Nagar+Delhi" target="_blank">Open in Google Maps →</a></p>
      </div>
    </section>
  );
}